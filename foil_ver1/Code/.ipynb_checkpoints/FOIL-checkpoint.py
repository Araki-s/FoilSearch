...
if __name__ == "__main__":
    #Pathを指定
    input_file = 'Z:/M2/foil/reference/'
    output_file = 'Z:/M2/foil/OUTPUT/'
    ...
    #plot_activation_cross_section = [['Au-197', 'MF=10 MT= 17 (n,3n) reaction  ',0.0],['Au-197', 'MF=10 MT= 17 (n,3n) reaction  ',318.6]]
    #plot_activation_cross_section = [['Hg-196', 'MF=10 MT= 16 (n,2n) reaction  ',0.0],['Hg-196', 'MF=10 MT= 16 (n,2n) reaction  ',176.08]]
    ...
    execute.plot_count('Calculate_count_self_absorbtion')
    #execute.plot_isomer() 
    #execute.Phase_3()
